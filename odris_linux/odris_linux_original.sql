REM
REM    Script: odris_linux_original.sql
...
REM      usually checks some info of oracle database on LINUX including server's hardware configuration.
REM
...
PROMPT =================================
PROMPT # 3.0 System Configuration (SC) #
PROMPT =================================
PROMPT
PROMPT =============================
