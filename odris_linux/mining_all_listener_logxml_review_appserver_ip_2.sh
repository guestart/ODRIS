...
# | Os env     : Linux                                                    |
# |                                                                       |
# | File       : mining_all_listener_logxml_review_appserver_ip_2.sh      |
# |                                                                       |
...
# |                                                                       |
# |              recently via mining all listener log file of xml format. |
# |                                                                       |
# |                                                                       |
# | Parameters : None.                                                    |
# |                                                                       |
...
#echo "========================================================================================"
#echo "#                                                                                      #"
#echo "# Now this Bash shell script will generate mining_all_logxml_appserver_ip_2_`date +%Y%m%d`.lst   #"
#echo "#                                                                                      #"
#echo "# and appserver_ip_2_`date +%Y%m%d`.lst                                                      #"
#echo "#                                                                                      #"
