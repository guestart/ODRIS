...
# | Parameters : None.                                                    |
# |                                                                       |
# | Modified   : 05/24/2019 (mm/dd/yyyy)                                  |
# |                                                                       |
...
oracle_sid_names=`ps -ef | grep ora_ | grep -v grep | awk '{print $NF}' | cut -d'_' -f3 | sort | uniq | grep -v '^$'`
oracle_sid_nums=`ps -ef | grep ora_ | grep -v grep | awk '{print $NF}' | cut -d'_' -f3 | sort | uniq | grep -v '^$' | wc -l`
...
ps -ef | grep ora_ | grep -v grep | awk '{print $NF}' | cut -d'_' -f3 | sort | uniq | grep -v '^$'
echo
echo "==============================================================================================="
echo "#                                                                                             #"
