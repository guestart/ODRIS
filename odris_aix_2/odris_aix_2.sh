...
# | Parameters : None.                                                    |
# |                                                                       |
# | Modified   : 05/19/2019 (mm/dd/yyyy)                                  |
# |                                                                       |
...
do
export ORACLE_SID=$n;
sqlplus -S / as sysdba <<EOF > /oracle/taiji/odris/report/odris_${n}_`date +%Y%m%d`.txt
@sqlplus_def_env.sql
...
echo "============================================================================================================="
echo
ls -l /oracle/taiji/odris/report/*`date +%Y%m%d`.txt | awk '{print $9}'
echo
